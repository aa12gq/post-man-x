    ...
    <div class="content-layout">
        ...
        >
          ...
          <div class="sidebar-container">
            ...
            <div class="activity-bar">
              ...
              >
                <el-tooltip :content="t('request.panel.sidebar.apis')" placement="right">
              ...
              >
                <el-tooltip :content="t('request.panel.sidebar.history')" placement="right">
              ...
              >
                <el-tooltip :content="t('request.panel.sidebar.environments')" placement="right">
              ...
              >
                <el-tooltip :content="t('request.panel.sidebar.importExport')" placement="right">
              ...
              >
                <el-tooltip :content="t('request.panel.sidebar.settings')" placement="right">
      ...
      <div class="main-content">
        ...
        <div class="request-response-wrapper">
            ...
            <div class="empty-state">
              <el-empty>
                <template #description>
                  ...
                  <p>
                    {{ t('request.panel.emptyState.description') }}
                  </p>
                </template>
                <template #default>
            ...
            <div class="request-workspace">
              <keep-alive>
                <RpcRequestRegion
                  ...
                  @update:unsaved="
                    (value: any) => currentTab?.id && handleUnsavedChange(currentTab.id, value)
                  "
                  @save="saveRequest"
          ...
          <template v-else-if="currentTab && currentTab.type === 'http'"> </template>
        </div>
      </div>
    </div>
      ...
      <div class="request-type-options">
        <div class="request-type-option" @click="selectRequestType('grpc')">
          ...
          <div class="option-content">
            ...
            <p>
              {{ t('request.panel.requestType.grpc.description') }}
            </p>
          </div>
        </div>
        <div class="request-type-option" @click="selectRequestType('http')">
          ...
          <div class="option-content">
            ...
            <p>
              {{ t('request.panel.requestType.http.description') }}
            </p>
          </div>
        </div>
      </div>
...
const activeView = ref<
  'collections' | 'apis' | 'history' | 'environments' | 'import-export' | 'settings' | null
...
const { history, addHistoryItem, loadHistory } = useRequestHistory()
...
const markTabAsUnsaved = (tabId: string) => {
  ...
  console.log('Current unsaved changes map:', Array.from(hasUnsavedChanges.value.entries()))
}
