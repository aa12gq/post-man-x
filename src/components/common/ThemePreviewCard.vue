  ...
  <div class="theme-preview-card group/card">
    ...
    >
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <div class="flex gap-1.5">
            <div
              class="w-2.5 h-2.5 rounded-full transition-transform duration-300 group-hover/card:scale-110"
              :style="{ backgroundColor: theme.colors['danger'] }"
            ></div>
            <div
              class="w-2.5 h-2.5 rounded-full transition-transform duration-300 group-hover/card:scale-110 delay-75"
              :style="{ backgroundColor: theme.colors['warning'] }"
            ></div>
            <div
              class="w-2.5 h-2.5 rounded-full transition-transform duration-300 group-hover/card:scale-110 delay-150"
          ...
          <div
            ...
            :style="{
              color: theme.isDark ? '#fff' : theme.colors.text,
              opacity: theme.isDark ? 0.9 : 0.8,
            }"
          >
            <span class="opacity-60">{{ theme.isDark ? "● " : "" }}</span>
            <span
              class="group-hover/card:text-primary-color transition-colors duration-300"
              >RPC Master</span
            >
          </div>
        </div>
          ...
          <div class="p-3">
            ...
            <div class="flex flex-col gap-1.5 mb-3">
              <div
                ...
                :style="{
                  width: '80%',
                  backgroundColor: theme.isDark ? '#fff' : theme.colors.text,
                  opacity: 0.1,
                }"
              ></div>
              <div
      ...
      <div
        ...
        :style="{
          background: `linear-gradient(120deg, ${theme.colors.primary}10, ${theme.colors.primary}05, transparent)`,
        }"
      ></div>
    </div>
  </div>
